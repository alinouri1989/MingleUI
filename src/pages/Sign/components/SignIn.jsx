      ...
      <form>
        <div className='inputs-container'>
          <div className='input-box'>
            ...
            <input name="Email" value={formData.Email} onChange={handleInputChange} type="email" required placeholder='Email' />
          </div>
          ...
          <div className='input-box password'>
            <div>
              ...
              <input name="Password" value={formData.Password} onChange={handleInputChange} type={showPassword ? "text" : "password"} placeholder='Şifre' />
            </div>
